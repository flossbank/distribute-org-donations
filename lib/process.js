...
exports.process = async ({ log, record, db, retriever, resolver, dynamo }) => {
  ...
  // Unless it's not a new dono; in that case we would have already taken our cut and Stripe's fees
  let donationAmount = 0
  if (amount > 0) {
    donationAmount = redistributedDonation ? amount * 1000 : ((amount * 0.96) - 30) * 1000
  }
